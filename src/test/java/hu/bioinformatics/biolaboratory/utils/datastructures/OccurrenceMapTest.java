...
public class OccurrenceMapTest {
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.INVALID_BUILD_DATA_PROVIDER_NAME,
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.VALID_BUILD_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.EMPTY_OCCURRENCE_MAP_DATA_PROVIDER_NAME,
            expectedExceptions = IllegalArgumentException.class)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.GET_OCCURRENCE_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.IS_EQUALS_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.COPY_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.INVALID_DECREASE_DATA_PROVIDER_NAME,
            expectedExceptions = IllegalArgumentException.class)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.VALID_DECREASE_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.INVALID_INCREASE_DATA_PROVIDER_NAME,
            expectedExceptions = IllegalArgumentException.class)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.VALID_INCREASE_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.INVALID_FILTER_GREATER_OR_EQUALS_DATA_PROVIDER_NAME,
            expectedExceptions = IllegalArgumentException.class)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.VALID_FILTER_GREATER_OR_EQUALS_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.MOST_FREQUENT_OCCURRENCES_DATA_PROVIDER_NAME)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.INVALID_MERGE_DATA_PROVIDER_NAME,
            expectedExceptions = IllegalArgumentException.class)
    ...
    @Test(dataProviderClass = OccurrenceMapTestDataProvider.class,
            dataProvider = OccurrenceMapTestDataProvider.VALID_MERGE_DATA_PROVIDER_NAME)
