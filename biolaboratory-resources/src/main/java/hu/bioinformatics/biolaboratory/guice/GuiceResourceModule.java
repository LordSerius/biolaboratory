...
import hu.bioinformatics.biolaboratory.resource.extension.impl.DnaCollectionResourceValidator;
...
import hu.bioinformatics.biolaboratory.resource.read.specialized.DnaCollectionLineReader;
...
public class GuiceResourceModule extends AbstractModule {
    ...
    public static final String DNA_COLLECTION_VALIDATOR_NAME = "dnaCollectionValidator";
    ...
    public static final String DNA_COLLECTION_LINE_READER_NAME = "dnaCollectionLineReader";
    ...
    protected void configure() {
        ...
        bind(ResourceValidator.class).annotatedWith(Names.named(DNA_VALIDATOR_NAME)).to(DnaResourceValidator.class).in(Scopes.SINGLETON);
        bind(ResourceValidator.class).annotatedWith(Names.named(DNA_COLLECTION_VALIDATOR_NAME)).to(DnaCollectionResourceValidator.class).in(Scopes.SINGLETON);
        ...
        bind(ResourceReader.class).annotatedWith(Names.named(DNA_COLLECTION_LINE_READER_NAME)).to(DnaCollectionLineReader.class).in(Scopes.SINGLETON);
